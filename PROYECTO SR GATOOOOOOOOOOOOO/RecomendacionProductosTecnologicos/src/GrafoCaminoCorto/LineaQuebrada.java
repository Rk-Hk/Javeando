...
public class LineaQuebrada
{
    ...
    /**
     * CREAMOS UN CONSTRUCTOR Q RECIBE PARAMETRO DE TIPO COORDENADAS
     */
        ...
        if(coordenadas != null){
            ...
            if(mostrarEtiqueta){
                ...
                if(coordenadas.size() == 2){
                    ...
                    ((Graphics2D)g).drawString("",(distanciaHorizontal/2) + xMenor,(distanciaVertical/2) + yMenor);
                }else{
                    int pos = coordenadas.size() / 2;

                    ((Graphics2D)g).drawString("",coordenadas.get(pos)[0]+3,coordenadas.get(pos)[1]-8);
