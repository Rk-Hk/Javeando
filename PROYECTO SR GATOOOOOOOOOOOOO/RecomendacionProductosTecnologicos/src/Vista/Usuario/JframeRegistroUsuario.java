...
public class JframeRegistroUsuario extends javax.swing.JFrame {
    ...
    /**
     * Creates new form JframeRegistroUsuario
     */
 Usuario usu = new Usuario();
   int  dni,celular,edad;
  String apeMater,apePater,nombre,correo,user,password;

    public JframeRegistroUsuario() {
        initComponents();
        setLocationRelativeTo(null);
        // inicia todos los campos limpios
  //limpiarCampos();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Datos del Usuario", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(204, 0, 0))); // NOI18N
  ...
  CargandoImagen(usu, jLabel11, jPanel1);     
 ...
 GestorPrincipal.getGestorUsuario().RegistrarUsuario(usu);
 limpiarCampos();
