...
import static Vista.Tienda.TiendaVirtual.lsComplementos;
 ...
 * @author Jeremy
 */
public class VistaComplementos extends javax.swing.JPanel {

    /**
     * Creates new form VistaPC
     */
    private int desli;
    static Complementos lappatodo;
    ...
    private void initComponents() {
        ...
        jSdeslisador.setMaximum(500);
        jSdeslisador.setMinimum(50);
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Seleccione", "AUDIFONOS", "PARLANTES", "MOUSE", "TECLADO", "SET DE LIMPIESA", "MONITOR" }));
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Seleccione", "SkullCandy", "Sony", "Panasonic" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double precio;
        boolean bol = false;
        ArrayList<Complementos> profin = new ArrayList<>();
        Complementos lapaux= new Complementos();
        System.out.println(lsComplementos.size());

        if(jComboBox3.getSelectedItem().toString().equalsIgnoreCase("Seleccione") 
            || jComboBox1.getSelectedItem().toString().equalsIgnoreCase("Seleccione")){
            ...
            precio=desli;
            lappatodo= new Complementos(nombre, null, precio, marca, null, 0, null);
            
            while(i<lsComplementos.size()){
                lapaux = lsComplementos.get(i);
                if(lappatodo.getMarca().equalsIgnoreCase(lapaux.getMarca())&&lappatodo.getPrecio()<=lapaux.getPrecio() && lappatodo.getNombre().equalsIgnoreCase(lapaux.getNombre())){
                    profin.add(lapaux);
                    bol=true;
                }
                i++;
