...
import static Vista.Tienda.TiendaVirtual.lsImpresora;
 ...
 * @author Jeremy
 */
public class VistaImpresora extends javax.swing.JPanel {

    /**
     * Creates new form VistaPC
     */
    private int desli;
    static Impresora impretodo;
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Seleccione", "Tinta Continua", "Laser", "Ploters" }));
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Seleccione", "Canon", "HP", "Sansung", "Epson" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double precio;
        boolean bol = false;
        ArrayList<Impresora> profin = new ArrayList<>();
        Impresora lapaux= new Impresora();
        System.out.println(lsImpresora.size());
        if(jComboBox3.getSelectedItem().toString().equalsIgnoreCase("Seleccione") 
            ...
            precio=desli;
            impretodo= new Impresora(tipo, null, precio, marca, null, null, 0, null);
            
            
            while(i<lsImpresora.size()){
                lapaux = lsImpresora.get(i);
                if(impretodo.getMarca().equalsIgnoreCase(lapaux.getMarca())&&impretodo.getPrecio()<=lapaux.getPrecio()&&impretodo.getTipo().equalsIgnoreCase(lapaux.getTipo())){
                    profin.add(lapaux);
                    bol=true;
                }
                i++;
            ...
            if(bol){
                ...
                JOptionPane.showMessageDialog(this, "NO SE ENCONTRARON IMPRESORAS CON ESAS CARACTERISTICAS", "LO SENTIMOS :c", JOptionPane.PLAIN_MESSAGE);
            }
